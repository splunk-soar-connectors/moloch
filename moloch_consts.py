...
MOLOCH_INVALID_LENGTH_MSG = 'Invalid value for parameter length'
MOLOCH_INVALID_START_TIME = 'Invalid value for parameter start_time'
MOLOCH_INVALID_END_TIME = 'Invalid value for parameter end_time'
MOLOCH_INVALID_CONFIG_PORT = 'Invalid value for config parameter port'
MOLOCH_INVALID_PARAM_PORT = 'Invalid value for parameter port'
